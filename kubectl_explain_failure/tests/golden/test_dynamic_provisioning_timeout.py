...
FIXTURE_DIR = os.path.join(BASE_DIR, "dynamic_provisioning_timeout")
...
def test_dynamic_provisioning_timeout_golden():
    ...
    # Inject PVC in Pending phase
    context["objects"] = {
        "pvc": {
            "pvc-timeout": {
                "metadata": {"name": "pvc-timeout"},
