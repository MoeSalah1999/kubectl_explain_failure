...
from kubectl_explain_failure.rules.base.storage.failed_mount import FailedMountRule
from kubectl_explain_failure.rules.base.storage.volume_expansion_failed import (
    VolumeExpansionFailedRule,
)
from kubectl_explain_failure.rules.compound.storage.volume_expansion_crashloop import (
    VolumeExpansionThenCrashLoopRule,
)
from kubectl_explain_failure.timeline import build_timeline

BASE_DIR = os.path.dirname(__file__)
FIXTURE_DIR = os.path.join(BASE_DIR, "volume_expansion_crashloop")
...
def test_volume_expansion_crashloop_golden():
    ...
    context["node"] = {
        "ip-10-0-51-12.ec2.internal": {
            "metadata": {"name": "ip-10-0-51-12.ec2.internal"}
        }
    }
    ...
    assert result["resolution"]["winner"] == "VolumeExpansionThenCrashLoop"
