...
FIXTURE_DIR = os.path.join(BASE_DIR, "hpa_conflicts_with_manual_scaling")
...
def test_hpa_conflicts_with_manual_scaling_golden():
    ...
    assert result["resolution"]["winner"] == "HPAConflictsWithManualScaling"
