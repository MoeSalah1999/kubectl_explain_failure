...
FIXTURE_DIR = os.path.join(BASE_DIR, "controller_ownership_conflict_chain")
...
def test_controller_ownership_conflict_chain_golden():
    ...
    assert result["resolution"]["winner"] == "ControllerOwnershipConflictChain"
