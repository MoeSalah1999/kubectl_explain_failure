...
FIXTURE_DIR = os.path.join(BASE_DIR, "deployment_rollback_loop")
...
def test_deployment_rollback_loop_golden():
    ...
    assert result["resolution"]["winner"] == "DeploymentRollbackLoop"
