...
FIXTURE_DIR = os.path.join(BASE_DIR, "network_policy_then_probe_failure")
...
def test_network_policy_then_probe_failure_golden():
    ...
    assert result["resolution"]["winner"] == "NetworkPolicyThenProbeFailure"
