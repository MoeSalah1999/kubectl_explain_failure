...
FIXTURE_DIR = os.path.join(BASE_DIR, "cni_init_failure_blocks_pods")
...
def test_cni_init_failure_blocks_pods_golden():
    ...
    context["node"] = {
        ...
        "worker-7": {"metadata": {"name": "worker-7"}},
    }
    ...
    assert result["resolution"]["winner"] == "CNIInitFailureBlocksPods"
