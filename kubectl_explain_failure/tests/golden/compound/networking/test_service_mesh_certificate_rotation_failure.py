...
FIXTURE_DIR = os.path.join(BASE_DIR, "service_mesh_certificate_rotation_failure")
...
def test_service_mesh_certificate_rotation_failure_golden():
    ...
    assert "ServiceMeshCertificateRotationFailure" in matched_rules
