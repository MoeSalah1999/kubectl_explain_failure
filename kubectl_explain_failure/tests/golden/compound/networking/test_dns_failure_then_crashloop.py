...
FIXTURE_DIR = os.path.join(BASE_DIR, "dns_failure_then_crashloop")
...
def test_dns_failure_then_crashloop_golden():
    ...
    assert result["resolution"]["winner"] == "DNSFailureThenCrashLoop"
