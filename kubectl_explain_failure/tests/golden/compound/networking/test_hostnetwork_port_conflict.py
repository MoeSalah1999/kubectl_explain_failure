...
FIXTURE_DIR = os.path.join(BASE_DIR, "hostnetwork_port_conflict")
...
def test_hostnetwork_port_conflict_golden():
    ...
    # Noise objects (consistent with other golden tests)
