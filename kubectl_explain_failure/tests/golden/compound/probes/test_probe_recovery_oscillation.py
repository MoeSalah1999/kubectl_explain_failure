...
FIXTURE_DIR = os.path.join(BASE_DIR, "probe_recovery_oscillation")
...
def test_probe_recovery_oscillation_golden():
    ...
    assert result["resolution"]["winner"] == "ProbeRecoveryOscillation"
