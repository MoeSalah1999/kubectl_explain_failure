...
FIXTURE_DIR = os.path.join(BASE_DIR, "probe_dependency_chain_failure")
...
def test_probe_dependency_chain_failure_golden():
    ...
    assert result["resolution"]["winner"] == "ProbeDependencyChainFailure"
