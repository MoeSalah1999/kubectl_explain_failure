...
FIXTURE_DIR = os.path.join(BASE_DIR, "sidecar_resource_starvation")
...
def test_sidecar_resource_starvation_golden():
    ...
    assert result["resolution"]["winner"] == "SidecarResourceStarvation"
