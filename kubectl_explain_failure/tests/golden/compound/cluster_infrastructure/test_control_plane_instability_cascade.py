...
FIXTURE_DIR = os.path.join(BASE_DIR, "control_plane_instability_cascade")
...
def test_control_plane_instability_cascade_golden():
    ...
    assert result["resolution"]["winner"] == "ControlPlaneInstabilityCascade"
