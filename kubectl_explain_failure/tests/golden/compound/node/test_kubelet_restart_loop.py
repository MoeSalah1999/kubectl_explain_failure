...
FIXTURE_DIR = os.path.join(BASE_DIR, "kubelet_restart_loop")
...
def test_kubelet_restart_loop_golden():
    ...
    assert result["resolution"]["winner"] == "KubeletRestartLoop"
    assert "NodeNotReady" in result["resolution"]["suppressed"]
