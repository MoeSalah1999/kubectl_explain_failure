...
FIXTURE_DIR = os.path.join(BASE_DIR, "runtime_restart_breaks_pod")
...
def test_runtime_restart_breaks_pod_golden():
    ...
    assert result["resolution"]["winner"] == "RuntimeRestartBreaksPod"
