...
FIXTURE_DIR = os.path.join(BASE_DIR, "node_provisioning_failure")
...
def test_node_provisioning_failure_golden():
    ...
    context["pvc"] = {
        "metadata": {"name": "payments-workdir"},
        "status": {"phase": "Bound"},
    }
    context["serviceaccount"] = {"metadata": {"name": "payments-worker"}}
    ...
    assert "NodeProvisioningFailure" in matched_rules
