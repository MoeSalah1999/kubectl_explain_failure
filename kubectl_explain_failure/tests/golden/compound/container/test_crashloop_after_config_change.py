...
FIXTURE_DIR = os.path.join(BASE_DIR, "crashloop_after_config_change")
...
def test_crashloop_after_config_change_golden():
    ...
    # Confidence (compound rule confidence expectation)
