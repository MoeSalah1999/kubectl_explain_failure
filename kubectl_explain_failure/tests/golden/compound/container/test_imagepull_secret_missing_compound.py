...
FIXTURE_DIR = os.path.join(BASE_DIR, "imagepull_secret_missing_compound")
...
def test_image_pull_secret_missing_compound_golden():
    ...
    # Build context explicitly (engine-style, consistent with other golden tests)
