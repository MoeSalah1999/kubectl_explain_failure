...
FIXTURE_DIR = os.path.join(BASE_DIR, "dependency_startup_ordering_failure")
...
def test_dependency_startup_ordering_failure_golden():
    ...
    assert result["resolution"]["winner"] == "DependencyStartupOrderingFailure"
