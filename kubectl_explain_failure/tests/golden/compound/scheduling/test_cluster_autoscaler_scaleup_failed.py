...
FIXTURE_DIR = os.path.join(BASE_DIR, "cluster_autoscaler_scaleup_failed")
...
def test_cluster_autoscaler_scaleup_failed_golden():
    ...
    assert "ClusterAutoscalerScaleUpFailed" in matched_rules
