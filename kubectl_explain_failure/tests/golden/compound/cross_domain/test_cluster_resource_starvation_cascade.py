...
FIXTURE_DIR = os.path.join(BASE_DIR, "cluster_resource_starvation_cascade")
...
def test_cluster_resource_starvation_cascade_golden():
    ...
    # Inject Node objects required by rule
    context["objects"] = {"node": nodes}
