...
FIXTURE_DIR = os.path.join(BASE_DIR, "crashloop_frequency_spike")
...
def test_crashloop_frequency_spike_golden():
    ...
    assert result["resolution"]["winner"] == "CrashLoopFrequencySpike"
