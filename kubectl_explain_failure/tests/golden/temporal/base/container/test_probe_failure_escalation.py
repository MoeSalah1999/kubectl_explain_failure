...
FIXTURE_DIR = os.path.join(BASE_DIR, "probe_failure_escalation")
...
def test_probe_failure_escalation_golden():
    ...
    assert result["resolution"]["winner"] == "ProbeFailureEscalation"
