...
FIXTURE_DIR = os.path.join(BASE_DIR, "deployment_rollout_oscillation")
...
def test_deployment_rollout_oscillation_golden():
    ...
    assert result["resolution"]["winner"] == "DeploymentRolloutOscillation"
