...
FIXTURE_DIR = os.path.join(BASE_DIR, "autoscaling_oscillation")
...
def test_autoscaling_oscillation_golden():
    ...
    assert result["resolution"]["winner"] == "AutoscalingOscillation"
