...
FIXTURE_DIR = os.path.join(BASE_DIR, "network_intermittent_packet_loss")
...
def test_network_intermittent_packet_loss_golden():
    ...
    assert result["resolution"]["winner"] == "NetworkIntermittentPacketLoss"
