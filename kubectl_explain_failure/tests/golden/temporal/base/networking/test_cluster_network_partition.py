...
FIXTURE_DIR = os.path.join(BASE_DIR, "cluster_network_partition")
...
def test_cluster_network_partition_golden():
    ...
    assert result["resolution"]["winner"] == "ClusterNetworkPartition"
