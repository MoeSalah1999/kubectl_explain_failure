...
FIXTURE_DIR = os.path.join(BASE_DIR, "cni_ip_exhaustion")
...
def test_cni_ip_exhaustion_golden():
    ...
    # Required objects for this rule
    context["objects"] = context.get("objects", {})
    context["objects"]["node"] = {"node1": {"metadata": {"name": "node1"}}}
