...
FIXTURE_DIR = os.path.join(BASE_DIR, "node_condition_oscillation")
...
def test_node_condition_oscillation_golden():
    ...
    assert result["resolution"]["winner"] == "NodeConditionOscillation"
