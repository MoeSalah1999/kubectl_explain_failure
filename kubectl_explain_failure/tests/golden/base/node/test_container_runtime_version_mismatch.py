...
FIXTURE_DIR = os.path.join(BASE_DIR, "container_runtime_version_mismatch")
...
def test_container_runtime_version_mismatch_golden():
    ...
    assert result["resolution"]["winner"] == "ContainerRuntimeVersionMismatch"
