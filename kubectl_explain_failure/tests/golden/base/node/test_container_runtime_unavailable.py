...
FIXTURE_DIR = os.path.join(BASE_DIR, "container_runtime_unavailable")
...
def test_container_runtime_unavailable_golden():
    ...
    assert result["resolution"]["winner"] == "ContainerRuntimeUnavailable"
