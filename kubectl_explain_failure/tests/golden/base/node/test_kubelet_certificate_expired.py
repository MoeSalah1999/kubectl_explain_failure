...
FIXTURE_DIR = os.path.join(BASE_DIR, "kubelet_certificate_expired")
...
def test_kubelet_certificate_expired_golden():
    ...
    assert result["resolution"]["winner"] == "KubeletCertificateExpired"
