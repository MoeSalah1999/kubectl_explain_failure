...
FIXTURE_DIR = os.path.join(BASE_DIR, "ephemeral_storage_exceeded")
...
def test_ephemeral_storage_exceeded_golden():
    ...
    # Minimal object graph for object-required rule
    ...
    # Harmless objects for completeness
