...
FIXTURE_DIR = os.path.join(BASE_DIR, "node_clock_skew_detected")
...
def test_node_clock_skew_detected_golden():
    ...
    assert result["resolution"]["winner"] == "NodeClockSkewDetected"
