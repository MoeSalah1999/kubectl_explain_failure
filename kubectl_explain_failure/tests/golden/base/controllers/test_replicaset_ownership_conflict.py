...
FIXTURE_DIR = os.path.join(BASE_DIR, "replicaset_ownership_conflict")
...
def test_replicaset_ownership_conflict_golden():
    ...
    assert result["resolution"]["winner"] == "ReplicaSetOwnershipConflict"
