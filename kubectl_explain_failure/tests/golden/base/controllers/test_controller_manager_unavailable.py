...
FIXTURE_DIR = os.path.join(BASE_DIR, "controller_manager_unavailable")
...
def test_controller_manager_unavailable_golden():
    ...
    assert result["resolution"]["winner"] == "ControllerManagerUnavailable"
