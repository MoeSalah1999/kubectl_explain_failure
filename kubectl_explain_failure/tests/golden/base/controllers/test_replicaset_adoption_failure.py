...
FIXTURE_DIR = os.path.join(BASE_DIR, "replicaset_adoption_failure")
...
def test_replicaset_adoption_failure_golden():
    ...
    assert result["resolution"]["winner"] == "ReplicaSetAdoptionFailure"
