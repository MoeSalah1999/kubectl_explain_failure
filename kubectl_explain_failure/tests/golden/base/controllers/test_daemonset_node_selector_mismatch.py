...
FIXTURE_DIR = os.path.join(BASE_DIR, "daemonset_node_selector_mismatch")
...
def test_daemonset_node_selector_mismatch_golden():
    ...
    # Add minimal PVC objects to satisfy engine normalization
