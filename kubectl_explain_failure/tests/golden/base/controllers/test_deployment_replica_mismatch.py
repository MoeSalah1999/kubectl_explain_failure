...
FIXTURE_DIR = os.path.join(BASE_DIR, "deployment_replica_mismatch")
...
def test_deployment_replica_mismatch_golden():
    ...
    # Inject actual Deployment under test
    if deployments:
        context["objects"]["deployment"] = deployments
