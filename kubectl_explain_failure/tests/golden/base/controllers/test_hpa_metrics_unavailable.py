...
FIXTURE_DIR = os.path.join(BASE_DIR, "hpa_metrics_unavailable")
...
def test_hpa_metrics_unavailable_golden():
    ...
    context["secret"] = {"metadata": {"name": "metrics-adapter-token"}}
    ...
    assert result["resolution"]["winner"] == "HPAMetricsUnavailable"
