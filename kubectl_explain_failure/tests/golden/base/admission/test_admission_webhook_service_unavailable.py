...
FIXTURE_DIR = os.path.join(BASE_DIR, "admission_webhook_service_unavailable")
...
def test_admission_webhook_service_unavailable_golden():
    ...
    # Noise objects for context completeness
