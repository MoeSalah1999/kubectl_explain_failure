...
FIXTURE_DIR = os.path.join(BASE_DIR, "csi_controller_unavailable")
...
def test_csi_controller_unavailable_golden():
    ...
    context["node"] = {
        "ip-10-0-31-44.ec2.internal": {
            "metadata": {"name": "ip-10-0-31-44.ec2.internal"}
        }
    }
    ...
    assert result["resolution"]["winner"] == "CSIControllerUnavailable"
