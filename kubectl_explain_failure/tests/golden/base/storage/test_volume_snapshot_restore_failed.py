...
FIXTURE_DIR = os.path.join(BASE_DIR, "volume_snapshot_restore_failed")
...
def test_volume_snapshot_restore_failed_golden():
    ...
    assert result["resolution"]["winner"] == "VolumeSnapshotRestoreFailed"
