...
FIXTURE_DIR = os.path.join(BASE_DIR, "volume_device_conflict")
...
def test_volume_device_conflict_golden():
    ...
    context["node"] = {
        "ip-10-0-12-34.ec2.internal": {
            "metadata": {"name": "ip-10-0-12-34.ec2.internal"}
        }
    }
    ...
    assert result["resolution"]["winner"] == "VolumeDeviceConflict"
