...
FIXTURE_DIR = os.path.join(BASE_DIR, "volume_mount_permission_denied")
...
def test_volume_mount_permission_denied_golden():
    ...
    assert result["resolution"]["winner"] == "VolumeMountPermissionDenied"
