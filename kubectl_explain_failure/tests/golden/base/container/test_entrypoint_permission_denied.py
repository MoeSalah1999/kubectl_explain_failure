...
FIXTURE_DIR = os.path.join(BASE_DIR, "entrypoint_permission_denied")
...
def test_entrypoint_permission_denied_golden():
    ...
    assert result["resolution"]["winner"] == "EntrypointPermissionDenied"
