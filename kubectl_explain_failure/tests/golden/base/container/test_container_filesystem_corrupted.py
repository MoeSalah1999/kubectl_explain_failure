...
FIXTURE_DIR = os.path.join(BASE_DIR, "container_filesystem_corrupted")
...
def test_container_filesystem_corrupted_golden():
    ...
    assert result["resolution"]["winner"] == "ContainerFilesystemCorrupted"
