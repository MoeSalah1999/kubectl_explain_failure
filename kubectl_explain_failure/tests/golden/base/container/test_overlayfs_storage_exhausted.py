...
FIXTURE_DIR = os.path.join(BASE_DIR, "overlayfs_storage_exhausted")
...
def test_overlayfs_storage_exhausted_golden():
    ...
    assert result["resolution"]["winner"] == "OverlayFSStorageExhausted"
