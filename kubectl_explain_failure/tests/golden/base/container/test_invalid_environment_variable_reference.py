...
FIXTURE_DIR = os.path.join(BASE_DIR, "invalid_environment_variable_reference")
...
def test_invalid_environment_variable_reference_golden():
    ...
    assert result["resolution"]["winner"] == "InvalidEnvironmentVariableReference"
