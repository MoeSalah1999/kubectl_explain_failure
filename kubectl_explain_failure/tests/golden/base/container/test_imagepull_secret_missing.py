...
FIXTURE_DIR = os.path.join(BASE_DIR, "imagepull_secret_missing")
...
def test_image_pull_secret_missing_golden():
    ...
    # Build minimal context for golden test
    ...
    # Inject secret object to satisfy ImagePullSecretMissingRule
    context["objects"] = {
        "secret": {
            "myregistrysecret": {
                "metadata": {"name": "myregistrysecret", "namespace": "default"}
            }
        }
    }
