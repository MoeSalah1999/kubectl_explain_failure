...
FIXTURE_DIR = os.path.join(BASE_DIR, "container_log_write_failure")
...
def test_container_log_write_failure_golden():
    ...
    assert result["resolution"]["winner"] == "ContainerLogWriteFailure"
