...
FIXTURE_DIR = os.path.join(BASE_DIR, "readiness_probe_failure")
...
def test_readiness_probe_failure_golden():
    ...
    # Noise objects (boost data completeness, match existing pattern)
