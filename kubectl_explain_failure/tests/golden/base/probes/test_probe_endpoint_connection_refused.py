...
FIXTURE_DIR = os.path.join(BASE_DIR, "probe_endpoint_connection_refused")
...
def test_probe_endpoint_connection_refused_golden():
    ...
    assert result["resolution"]["winner"] == "ProbeEndpointConnectionRefused"
