...
FIXTURE_DIR = os.path.join(BASE_DIR, "extended_resource_unavailable")
...
def test_extended_resource_unavailable_golden():
    ...
    # Node exists but does NOT advertise the extended resource
    context["node"] = {
        "node1": {
            "metadata": {"name": "node1"},
