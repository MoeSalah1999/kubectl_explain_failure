...
FIXTURE_DIR = os.path.join(BASE_DIR, "sidecar_termination_block")
...
def test_sidecar_termination_block_golden():
    ...
    assert result["resolution"]["winner"] == "SidecarTerminationBlock"
