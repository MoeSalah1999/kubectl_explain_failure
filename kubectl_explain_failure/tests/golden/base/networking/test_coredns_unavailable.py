...
FIXTURE_DIR = os.path.join(BASE_DIR, "coredns_unavailable")
...
def test_coredns_unavailable_golden():
    ...
    context["pvc"] = {
        "metadata": {"name": "catalog-cache"},
        "status": {"phase": "Bound"},
    }
    context["serviceaccount"] = {"metadata": {"name": "catalog-api"}}
    ...
    assert "CoreDNSUnavailable" in matched_rules
