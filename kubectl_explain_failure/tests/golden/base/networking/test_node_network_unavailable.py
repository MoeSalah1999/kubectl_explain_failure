...
FIXTURE_DIR = os.path.join(BASE_DIR, "node_network_unavailable")
...
def test_node_network_unavailable_golden():
    ...
    context["secret"] = {"metadata": {"name": "cluster-creds"}}
    ...
    assert result["resolution"]["winner"] == "NodeNetworkUnavailable"
