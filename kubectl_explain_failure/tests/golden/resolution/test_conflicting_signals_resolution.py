...
FIXTURE_DIR = os.path.join(BASE_DIR, "conflicting_signals_resolution")
...
def test_conflicting_signals_resolution_golden():
    ...
    # Inject PVC object (Pending)
    context["pvc"] = {
        "metadata": {"name": "data-pvc"},
        "status": {"phase": "Pending"},
    }

    # Minimal noise objects
