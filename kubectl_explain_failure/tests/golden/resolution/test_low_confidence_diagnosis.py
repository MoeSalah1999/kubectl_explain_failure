...
FIXTURE_DIR = os.path.join(BASE_DIR, "low_confidence_diagnosis")
...
def test_low_confidence_diagnosis_golden():
    ...
    assert result["resolution"]["winner"] == "LowConfidenceDiagnosis"
